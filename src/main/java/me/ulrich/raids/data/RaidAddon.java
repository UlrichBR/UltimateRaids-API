...
public abstract class RaidAddon {
    ...
    /** Registers an item provider owned by this addon. */
    ...
    /** Registers an entity provider owned by this addon. */
    ...
    /** Registers a group provider owned by this addon. */
    ...
    /** Registers a border provider owned by this addon. */
    ...
    /** Registers an economy provider owned by this addon. */
    ...
    /** Registers a schematic provider owned by this addon. */
    ...
    /** Registers a custom reward owned by this addon. */
    ...
    /** Registers a custom objective owned by this addon. */
    ...
    /** Registers a custom requirement owned by this addon. */
    ...
    /**
     * Removes all registrations still owned by this addon.
    ...
    private UltimateRaids requireCore() {
        if (plugin == null) {
            throw new IllegalStateException("Addon has not been initialized by UltimateRaids");
        }
        return plugin;
    }
