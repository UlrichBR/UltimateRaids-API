...
public final class RaidWaveStartEvent extends RaidEvent {
    private static final HandlerList HANDLERS = new HandlerList();
    private final RaidStageView stage;
    private final String waveId;
    private final int waveIndex;

    public RaidWaveStartEvent(RaidInstanceView instance, RaidStageView stage, String waveId, int waveIndex) {
        super(instance);
        this.stage = stage;
